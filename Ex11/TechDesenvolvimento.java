...
public abstract class TechDesenvolvimento {
    ...
    public TechDesenvolvimento(int id, String nomeLinguagem, String nomeFramework, String descricaoLinguagem) {
        this.id = id;
        this.nomeLinguagem = nomeLinguagem;
        this.nomeFramework = nomeFramework;
        this.descricaoLinguagem = descricaoLinguagem;
